  ...
  <div class="v-step" :id="'v-step-' + hash" :ref="'v-step-' + hash">
    ...
    <slot name="actions">
      <div class="v-step__buttons">
        <button @click="stop" v-if="!isLast" class="v-step__button">Chiudi</button>
        <button @click="previousStep" v-if="!isFirst" class="v-step__button">Precedente</button>
        <button @click="nextStep" v-if="!isLast" class="v-step__button">Successivo</button>
        <button @click="stop" v-if="isLast" class="v-step__button">Fine</button>
      </div>
    </slot>

    <div class="v-step__arrow" :class="{ 'v-step__arrow--dark': step.header && step.header.title }" x-arrow></div>
  </div>
</template>
